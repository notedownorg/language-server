...
install: clean
	go build -ldflags "\
		...
		-X github.com/notedownorg/language-server/pkg/version.commit=$(COMMIT) \
		-X github.com/notedownorg/language-server/pkg/version.date=$(DATE)" \
